...
public class CompanyWeb extends Activity implements View.OnClickListener {
    ...
    private void initview() {
        ...
        editText = (EditText) findViewById(R.id.comWebInput);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.compelete:
                ...
                intent.putExtra("web",editText.getText().toString());
                setResult(0,intent);
                finish();
                break;
            default:
