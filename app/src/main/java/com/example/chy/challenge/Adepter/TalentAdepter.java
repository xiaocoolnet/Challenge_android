...
public class TalentAdepter extends ArrayAdapter<TalentResumeInfo.DataBean>{
    private int resourceId;
    public TalentAdepter(Context context, int textViewResourceId, List<TalentResumeInfo.DataBean> objects) {
